...
| **Direct device workout archives** | CYCPLUS M1 completed FIT workouts over local Bluetooth | [CYCPLUS M1 workout archive](docs/LIVE_SENSORS.md#cycplus-m1-workout-archive) and [workout calendar](docs/WORKOUT_CALENDAR.md) |
