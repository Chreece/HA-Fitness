...
async def async_setup(hass: HomeAssistant, config: dict) -> bool:
    ...
    # Live sensor infrastructure is owned exclusively by the Local Sensors
    # config entry. Global Fitness startup must never initialize/probe radios,
    # start discovery, create config flows, or wait for live providers.
    return True
